...
//
    ...
    public static void centerForm() {
        ...
        SelenideElement textInfoVersionsProg = collSystemForms.get(13).shouldBe(text("2.6~244"));
        ...
        SelenideElement textInfoVersionsAPI = collSystemForms.get(19).shouldBe(text("1.3.20"));
